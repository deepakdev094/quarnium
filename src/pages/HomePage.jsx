...
const HomePage = () => {
  ...
  return (
    <motion.div style={{ height: "400vh", background: "#323C29" }}>
      <div
        style={{
          position: "fixed",
          top: 0,
      ...
      <div className="relative z-10 flex flex-col gap-y-16 pt-[120px] lg:pt-0 px-4 md:block">
        ...
        >
          ...
          <div className="relative group inline-block pt-2">
            <button className="relative  z-10 px-6 py-3 bg-yellow-500 text-black font-semibold rounded-full overflow-hidden">
              Explore more
            </button>
            <span className="absolute inset-0 rounded-full border-2 border-yellow-300 opacity-0 group-hover:opacity-100 group-hover:animate-ripple pointer-events-none" />
          </div>
        </motion.div>
